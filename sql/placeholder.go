...
var (
	...
	// AtSign is a PlaceholderFormat instance that replaces placeholders with
...
type atSignFormat struct{}

func (atSignFormat) ReplacePlaceholders(sql string) (string, error) {
